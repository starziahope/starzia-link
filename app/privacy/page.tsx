...
export const metadata: Metadata = {
  title: "개인정보 처리방침",
  description: "한입 링크의 개인정보 처리방침 안내 페이지입니다.",
  robots: { index: true, follow: true },
};

const SERVICE_NAME = "한입 링크";
const OPERATOR_NAME = "홍길동";
const CONTACT_EMAIL = "ddddasd1@naver.com";
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-[var(--text)]">
      ...
      <section id="s1" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">1. 개인정보의 처리 목적</h2>
        <p className="mb-3 leading-relaxed">
          {SERVICE_NAME}은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
        ...
        <ol className="list-decimal space-y-2 pl-6 leading-relaxed">
          <li>
            ...
            <br />
            회원 가입 의사 확인, 본인 식별·인증, 회원자격 유지·관리, 서비스
            부정이용 방지 목적으로 개인정보를 처리합니다.
          </li>
          <li>
            <strong>서비스 제공</strong>
            <br />
            {SERVICE_NAME}의 기능 제공 및 서비스 운영을 위하여 개인정보를
            처리합니다.
          </li>
          <li>
            <strong>고충 처리</strong>
            <br />
            정보주체의 문의사항 확인 및 사실조사를 위한 연락·통지, 처리결과 통보
            목적으로 개인정보를 처리합니다.
          </li>
        </ol>
      </section>
      ...
      <section id="s2" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">2. 처리하는 개인정보의 항목</h2>
        <div className="mb-4">
        ...
        <div>
          ...
          <p className="leading-relaxed">
            IP 주소, 쿠키, 서비스 이용 기록, 접속 로그, 브라우저 정보, 기기 정보
          </p>
        </div>
      </section>
      ...
      <section id="s4" className="mb-10 scroll-mt-20">
        ...
        <p className="mb-3 leading-relaxed">
          {SERVICE_NAME}은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
          불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.
        </p>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li>
            <strong>파기 절차</strong>: 이용자의 회원 탈퇴 요청 또는 보유기간
            만료 시 즉시 파기
          </li>
          <li>
            <strong>파기 방법</strong>: 전자적 파일은 복구 및 재생이 불가능한
            방법으로 영구 삭제
          </li>
        </ul>
      </section>
      ...
      <section id="s5" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">5. 개인정보 처리업무의 위탁</h2>
        <p className="mb-4 leading-relaxed">
        ...
        <p className="mt-3 text-sm text-[var(--text-sub)] leading-relaxed">
          ...
          개인정보의 안전한 처리를 위한 기술적·관리적 보호조치, 재위탁 제한,
          관리·감독 등 책임에 관한 사항을 계약에 반영하고 있습니다.
        </p>
      </section>
      ...
      <section id="s6" className="mb-10 scroll-mt-20">
        ...
        <p className="mb-3 leading-relaxed">
          정보주체는 {SERVICE_NAME}에 대해 언제든지 다음과 같은 개인정보 보호
          관련 권리를 행사할 수 있습니다.
        </p>
        ...
        <p className="leading-relaxed">
          ...
          로 서면, 이메일 등을 통하여 하실 수 있으며 {SERVICE_NAME}은 이에 대해
          지체 없이 조치하겠습니다.
        </p>
      </section>
      ...
      <section id="s7" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li>
            <strong>기술적 조치</strong>: 접근 권한 관리, 비밀번호 단방향 암호화
            저장, HTTPS 통신 암호화, Row Level Security(RLS) 적용
          </li>
          <li>
            <strong>관리적 조치</strong>: 개인정보 취급 담당자 최소화, 정기적인
            자체 점검
          </li>
          <li>
      ...
      <section id="s8" className="mb-10 scroll-mt-20">
        ...
        <p className="mb-3 leading-relaxed">
          {SERVICE_NAME}은 로그인 상태 유지 및 이용자 맞춤 서비스 제공을 위해
          쿠키(cookie)를 사용합니다.
        </p>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li>
            <strong>사용 목적</strong>: 로그인 세션 유지, 이용자 환경 설정 저장
          </li>
          <li>
            <strong>거부 방법</strong>: 웹브라우저 설정 &gt; 개인정보 보호 및
            보안 메뉴에서 쿠키 저장을 거부할 수 있습니다. 다만, 쿠키 저장을
      ...
      <section id="s9" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">9. 개인정보 보호책임자</h2>
        <p className="mb-3 leading-relaxed">
      ...
      <section id="s10" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">10. 권익침해 구제방법</h2>
        <p className="mb-3 leading-relaxed">
      ...
      <section id="s11" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">11. 개인정보 처리방침의 변경</h2>
        <p className="leading-relaxed">
          이 개인정보 처리방침은 {EFFECTIVE_DATE}부터 적용됩니다. 법령, 정책
          또는 보안기술 변경에 따라 내용이 추가·삭제 및 수정될 경우 변경 사항을
